 ...
 */
public class GarageButton extends BuildingButtons
{
    //Edit these fields
    private final String tileName = "Garage";
    ...
    public void act() 
    {
        ...
        if (Greenfoot.mouseClicked(this) && ((MainWorld)getWorld()).money > cost) {
                ...
                //                                    VVVVVVVVVVVV
                ((MainWorld)getWorld()).addObject(new GarageTile(cost), mouse.getX(), mouse.getY());
            }
    }    
}
