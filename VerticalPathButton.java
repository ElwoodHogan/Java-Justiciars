 ...
 */
public class VerticalPathButton extends PathsButtons
{
    //Edit these fields
    private final String tileName = "Path";
    ...
    public void act() 
    {
        ...
        if (Greenfoot.mouseClicked(this) && ((MainWorld)getWorld()).money > cost) {
                ...
                //                                    VVVVVVVVVVVV
                ((MainWorld)getWorld()).addObject(new VerticalPathTile(cost), mouse.getX(), mouse.getY());
            }
    }    
}
