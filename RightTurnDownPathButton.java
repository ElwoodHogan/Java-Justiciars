 ...
 */
public class RightTurnDownPathButton extends PathsButtons
{
    //Edit these fields
    private final String tileName = "Path Turn";
    ...
    public void act() 
    {
        ...
        if (Greenfoot.mouseClicked(this) && ((MainWorld)getWorld()).money > cost) {
                ...
                //                                    VVVVVVVVVVVV
                ((MainWorld)getWorld()).addObject(new RightTurnDownPathTile(cost), mouse.getX(), mouse.getY());
            }
    }    
}
