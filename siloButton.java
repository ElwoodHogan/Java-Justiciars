 ...
 */
public class siloButton extends BuildingButtons
{
    //Edit these fields
    private final String tileName = "Silo";
    public double cost = 120;
    ...
    public void act() 
    {
        ...
        if (Greenfoot.mouseClicked(this) && ((MainWorld)getWorld()).money > cost) {
                ...
                //                                    VVVVVVVVVVVV
                ((MainWorld)getWorld()).addObject(new SiloTile(cost), mouse.getX(), mouse.getY());
            }
    }    
}
