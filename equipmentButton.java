...
/**
 * Write a description of class equipmentButton here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class equipmentButton extends MainButtons
{
    
    private final String buttonName = "Equipment";
    public void act() 
    {
        ...
        if (Greenfoot.mouseClicked(this)) {
                ((MainWorld)getWorld()).addEquipmentButtons();
