...
/**
 * Write a description of class horseTile here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class horseTile extends Animals
{
    ...
    public horseTile(double costIn) {
            cost = costIn;
        }
    ...
    public void act() 
    {
        ...
        if (placed == false) {
            ...
            if (isTouching(null)) {
                ...
                //if all is true, then it spawns the horse on the mouse location and subtracts the appropriate cost.
