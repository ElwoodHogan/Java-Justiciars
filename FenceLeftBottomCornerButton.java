 ...
 */
public class FenceLeftBottomCornerButton extends FencingButtons
{
    //Edit these fields
    private final String tileName = "Fence Corner";
    ...
    public void act() 
    {
        ...
        if (Greenfoot.mouseClicked(this) && ((MainWorld)getWorld()).money > cost) {
                ...
                //                                    VVVVVVVVVVVV
                ((MainWorld)getWorld()).addObject(new FenceLeftBottomCornerTile(cost), mouse.getX(), mouse.getY());
            }
    }    
}
