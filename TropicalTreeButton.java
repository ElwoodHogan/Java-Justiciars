 ...
 */
public class TropicalTreeButton extends DecorButtons
{
    //Edit these fields
    private final String tileName = "Tropical Tree";
    ...
    public void act() 
    {
        ...
        if (Greenfoot.mouseClicked(this) && ((MainWorld)getWorld()).money > cost) {
                ...
                //                                    VVVVVVVVVVVV
                ((MainWorld)getWorld()).addObject(new TropicalTreeTile(cost), mouse.getX(), mouse.getY());
            }
    }    
}
