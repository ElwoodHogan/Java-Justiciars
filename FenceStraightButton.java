 ...
 */
public class FenceStraightButton extends FencingButtons
{
    //Edit these fields
    private final String tileName = "Fence";
    ...
    public void act() 
    {
        ...
        if (Greenfoot.mouseClicked(this) && ((MainWorld)getWorld()).money > cost) {
                ...
                //                                    VVVVVVVVVVVV
                ((MainWorld)getWorld()).addObject(new FenceStraightTile(cost), mouse.getX(), mouse.getY());
            }
    }    
}
