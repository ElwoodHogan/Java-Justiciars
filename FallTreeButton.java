 ...
 */
public class FallTreeButton extends DecorButtons
{
    //Edit these fields
    private final String tileName = "Fall Tree";
    ...
    public void act() 
    {
        ...
        if (Greenfoot.mouseClicked(this) && ((MainWorld)getWorld()).money > cost) {
                ...
                //                                    VVVVVVVVVVVV
                ((MainWorld)getWorld()).addObject(new FallTreeTile(cost), mouse.getX(), mouse.getY());
            }
    }    
}
