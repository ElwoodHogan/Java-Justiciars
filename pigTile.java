...
/**
 * Write a description of class pigTile here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class pigTile extends Animals
{
    ...
    public void act() 
    {
        ...
        if (placed == false) {
            ...
            if (isTouching(null)) {
                ...
                //if all is true, then it spawns the pig on the mouse location and subtracts the appropriate cost.
